    ...
    static var sample: Menu {
        Menu(
            ...
            foods: [
                ...
                Food(id: "1235", name: "Pizza beijinho", type: "pizza doce", price: "46", previewUrl: "", description: "Text ever since the 1500s, when an unknown printer took a galley"),
                Food(id: "1236", name: "Pizza brigadeiro", type: "pizza doce", price: "34", previewUrl: "", description: "Of type and scrambled it to make a type specimen book. It has")
            ]
        )
    }
}
